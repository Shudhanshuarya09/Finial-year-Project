...
if (fs.existsSync("./public/assets")) {
  ...
  console.log("Warning: Asset path does not exist:", "./public/assets");
}
...
if (fs.existsSync(path.join(__dirname, "storage"))) {
  ...
  console.log("Warning: Storage folder does not exist");
}
...
if (fs.existsSync(path.join(__dirname, "uploads"))) {
  ...
  console.log("Warning: Uploads folder does not exist");
}
...
app.use(
	session({
		...
		store: MongoStore.create(
			{
				//DB Connection URL
				mongoUrl: `mongodb+srv://shudhanshuarya111:Five55555@cluster0.k50od.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`,
